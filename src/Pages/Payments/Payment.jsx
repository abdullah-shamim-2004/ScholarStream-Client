  ...
  return (
    <div className="h-[80vh] ">
      {user ? (
        ...
        <div className="max-w-md my-10 mx-auto p-6 shadow-lg rounded-xl bg-white text-center">
          {" "}
          <h2 className="text-xl font-black ">Please log in first.</h2>
          <Link className="btn btn-primary my-2 " to="/auth/login">Login</Link>
        </div>
      )}
    </div>
  );
